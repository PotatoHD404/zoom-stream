...
rm -rf /var/run/pulse /var/lib/pulse /home/zoomstream/.config/pulse
...
if [[ "$DEBUG" == "True" ]]; then
  ...
  xfce4-terminal -H --geometry 85x7+0 --title=zoomstream --hide-toolbar --hide-menubar --hide-scrollbar --hide-borders --zoom=-3 -e "python3 -u ${HOME}/zoomstream.py"
else
  # Exit container if something failed
  xfce4-terminal --geometry 85x7+0 --title=zoomstream --hide-toolbar --hide-menubar --hide-scrollbar --hide-borders --zoom=-3 -e "python3 -u ${HOME}/zoomstream.py"
fi